...
@section('content')
  ...
  <div class="container about-us-container">
  	 ...
  	 <p>Your share of profit from mining is estimated according to some parameters. You can find it from “Hash Bazaar” home page or from your panel. You could join us by purchasing just one therra hash power or more.</p>
  	  <p>We have some advantages about what we are offering you, the most important one is our ROI (Return on investment) suggestion. This profitable plan is made in the places where the electricity cost is low. Since the optimum locations we have considered to set up our mining farms or maybe from now on your mining farm.</p>
  </div>
