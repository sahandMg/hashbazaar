...
<body>
    ...
    <div class="container">
        ...
        <div style="direction: rtl;text-align: right">
            <h1 style="text-align: right">بازیابی کلمه عبور</h1>
            <p style="text-align: right;">با سلام</p>
            <p style="text-align: right;">کلمه عبور جدید شما : <b>{{$pass}}</b></p>
            <p style="text-align: right;">لطفا بعد از ورود به حساب کاربری خود، از قسمت تنظیمات، کلمه عبور خود را تغییر دهید</p>
        </div>
        @else
