                 ...
                 <!-- Bitcoin -->
                    <div class="faq-customerservice-questions">
                        <ul class="faq-question-list-container" style="color: #696967">
                            ...
                            <li class="faq-question-list">
                                <h5 class="faq-question">بیت کوین چگونه قیمت گذاری میشود ؟</h5>
                                <div class="faq-answer">
                                 <p>
                                  قیمت گذاری بیت کوین بر اساس عرضه و تقاضا و در یک بازار کارا مشخص میشود. این قیمت به دلار آمریکا براساس جدیدترین تجارت بیت کوین و دلار آمریکا در هر بازار محاسبه می شود و به همین دلیل چند بار در ثانیه نوسان می کند.
                                 </p>
                                </div>
                            </li>
                            <li class="faq-question-list">
                                <h5 class="faq-question">هزینه ی شبکه چگونه تعیین میشود ؟</h5>
                                <div class="faq-answer">
                                 <p>
                                  هزینه شبکه یا همان کارمزد نقل و انتقال ارز دیجیتال، درصد بسیار ناچیزی از ارز دیجیتالی است که میخواهید بر بستر شبکه بلاک چین جابجا کنید.
                                 </p>
                                </div>
                            </li>
                            <li class="faq-question-list">
                                <h5 class="faq-question">کارمزد نقل و انتقال ارزدیجیتال به چه کسانی داده میشود ؟</h5>
                                <div class="faq-answer">
                                 <p>
                                   این کارمزد به ماینرهای شبکه داده می شود تا تراکنش شما را تایید کنند.
                                 </p>
                                </div>
                            </li>
                        </ul>
