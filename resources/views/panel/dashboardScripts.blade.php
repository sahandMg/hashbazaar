...
<script type="text/javascript">
    ...
    var dollarToToman = parseInt({!! str_replace(',','',env('hash_toman_classic')) !!});
    var dollarToToman_zero = parseInt({!! str_replace(',','',env('hash_toman_zero')) !!});
    console.log(dollarToToman_zero,dollarToToman);
...
//                            console.log(thPrice);
    ...
    if(planType == 2){
        cost.innerHTML = dollarToToman * slider.value ;
    }else if(planType == 3){
        cost.innerHTML = dollarToToman_zero * slider.value ;
    }
...
//                        console.log(resp)
    ...
    function refershThPrice() {
        ...
        console.log("refersh fun");
        var planKind = parseInt($('#planType').val()) ;
        console.log(planKind);
        if(planKind == 2){
            cost.innerHTML = dollarToToman * slider.value ;
        }else if(planKind == 3){
            cost.innerHTML = dollarToToman_zero * slider.value ;
