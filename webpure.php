p<?php defined('BASEPATH') OR exit('No direct script access allowed');
...
class Auth extends CI_Controller {
			...
			if ($this->form_validation->run() === TRUE)
			{
				...
				if ($insert)
				{
					...
					// paystarTransactionId
                        ...
                        curl_close($ch);
                        // $transID = $this->curl_post('https://paystar.ir/api/create', [
                        //         'pin'          => $pin,
                        //     	'amount'       => $amount,
                        //     	'callback'     => $callback,
                        //     	'description'  => $description,
	...
	function return_bank_mellat()
	{
		...
		$exchange = $this->db->get('app_exchanges')->row();
// ================================================================================
        // $pay_verify =  $this->curl_post('https://paystar.ir/api/verifycardnumber', [
		// 	'pin' 	=> 'AB2CC261EE0C2A284642',
        //     'transid' => $_POST['transid'],
        //     'amount' => $exchange->rials/10,
        // ]);
